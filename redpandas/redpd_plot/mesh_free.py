...
#     '''
#     Plots wiggles and STFT for big bird signal
#
...
#
#     # Load STFT signals
#     plot_mesh_pandas(df=df_stft,
#                      mesh_time_label='signal_stft_time_s',
#                      mesh_frequency_label='signal_stft_frequency_hz',
#                      mesh_tfr_label='signal_stft_bits',
#                      t0_sig_epoch_s=df_stft['class_epoch'][0],
#                      sig_id_label='station_id',
#                      fig_title='STFT for big bird signal',
#                      frequency_hz_ymin=1,
#                      frequency_hz_ymax=9,
#                      frequency_scaling="log")
#     plt.show()
    # SKYFALL DATA
    # INPUT_DIR = "/Users/meritxell/Documents/skyfall/rpd_files/Skyfall_df.parquet"
    # print('Load parquet...', end='')
    # df0 = pd.read_parquet(INPUT_DIR)
    # print('Done.')
    # df_column_unflatten(df=df0, col_wf_label="accelerometer_wf_raw", col_ndim_label="accelerometer_wf_raw_ndim")
    # df_column_unflatten(df=df0, col_wf_label="accelerometer_wf_highpass", col_ndim_label="accelerometer_wf_highpass_ndim")
    #
    # df_column_unflatten(df=df0, col_wf_label="barometer_wf_raw", col_ndim_label="barometer_wf_raw_ndim")
    # df_column_unflatten(df=df0, col_wf_label="barometer_wf_highpass", col_ndim_label="barometer_wf_highpass_ndim")
    #
    # df_column_unflatten(df=df0, col_wf_label="gyroscope_wf_raw", col_ndim_label="gyroscope_wf_raw_ndim")
    # df_column_unflatten(df=df0, col_wf_label="gyroscope_wf_highpass", col_ndim_label="gyroscope_wf_highpass_ndim")
    #
    # df_column_unflatten(df=df0, col_wf_label="magnetometer_wf_raw", col_ndim_label="magnetometer_wf_raw_ndim")
    # df_column_unflatten(df=df0, col_wf_label="magnetometer_wf_highpass", col_ndim_label="magnetometer_wf_highpass_ndim")
    #
    # tfr_order = 12
    # tfr_type = 'stft'
    #
    ...
    #
    #                  t0_sig_epoch_s=df0[audio_epoch_s_label][0][0],
